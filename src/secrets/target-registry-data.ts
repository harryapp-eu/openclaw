...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "channels.googlechat.accounts.*.userAuth.accessToken",
    targetType: "channels.googlechat.accounts.*.userAuth.accessToken",
    configFile: "openclaw.json",
    pathPattern: "channels.googlechat.accounts.*.userAuth.accessToken",
    refPathPattern: "channels.googlechat.accounts.*.userAuth.accessTokenRef",
    secretShape: SIBLING_REF_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.googlechat.accounts.*.userAuth.refreshToken",
    targetType: "channels.googlechat.accounts.*.userAuth.refreshToken",
    configFile: "openclaw.json",
    pathPattern: "channels.googlechat.accounts.*.userAuth.refreshToken",
    refPathPattern: "channels.googlechat.accounts.*.userAuth.refreshTokenRef",
    secretShape: SIBLING_REF_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.googlechat.accounts.*.userAuth.clientId",
    targetType: "channels.googlechat.accounts.*.userAuth.clientId",
    configFile: "openclaw.json",
    pathPattern: "channels.googlechat.accounts.*.userAuth.clientId",
    refPathPattern: "channels.googlechat.accounts.*.userAuth.clientIdRef",
    secretShape: SIBLING_REF_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.googlechat.accounts.*.userAuth.clientSecret",
    targetType: "channels.googlechat.accounts.*.userAuth.clientSecret",
    configFile: "openclaw.json",
    pathPattern: "channels.googlechat.accounts.*.userAuth.clientSecret",
    refPathPattern: "channels.googlechat.accounts.*.userAuth.clientSecretRef",
    secretShape: SIBLING_REF_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.googlechat.userAuth.accessToken",
    targetType: "channels.googlechat.userAuth.accessToken",
    configFile: "openclaw.json",
    pathPattern: "channels.googlechat.userAuth.accessToken",
    refPathPattern: "channels.googlechat.userAuth.accessTokenRef",
    secretShape: SIBLING_REF_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.googlechat.userAuth.refreshToken",
    targetType: "channels.googlechat.userAuth.refreshToken",
    configFile: "openclaw.json",
    pathPattern: "channels.googlechat.userAuth.refreshToken",
    refPathPattern: "channels.googlechat.userAuth.refreshTokenRef",
    secretShape: SIBLING_REF_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.googlechat.userAuth.clientId",
    targetType: "channels.googlechat.userAuth.clientId",
    configFile: "openclaw.json",
    pathPattern: "channels.googlechat.userAuth.clientId",
    refPathPattern: "channels.googlechat.userAuth.clientIdRef",
    secretShape: SIBLING_REF_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.googlechat.userAuth.clientSecret",
    targetType: "channels.googlechat.userAuth.clientSecret",
    configFile: "openclaw.json",
    pathPattern: "channels.googlechat.userAuth.clientSecret",
    refPathPattern: "channels.googlechat.userAuth.clientSecretRef",
    secretShape: SIBLING_REF_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
